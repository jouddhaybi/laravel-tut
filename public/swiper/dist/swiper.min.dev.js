...
var Swiper = function () {
  ...
  function M(e) {
    return function (t) {
      return Math.abs(t) > 0 && e.browser && e.browser.need3dFix && Math.abs(t) % 90 == 0 ? t + 0.001 : t;
    };
  }
  ...
  var R = {
    ...
    loopFix: function loopFix(e) {
      ...
      var I = 0,
          z = 0;
      var A = (E ? c[r].column : r) + (f && void 0 === i ? -w / 2 + 0.5 : 0);
      ...
      if (d.allowSlidePrev = p, d.allowSlideNext = u, d.controller && d.controller.control && !l) {
        ...
        }) : d.controller.control instanceof d.constructor && d.controller.control.params.loop && d.controller.control.loopFix(_objectSpread({}, _e30, {
  ...
  function le(e) {
    ...
    var i = function i(e) {
      if ("string" == typeof e) {
        ...
        _t28.innerHTML = e, a.append(_t28.children[0]), _t28.innerHTML = "";
      } else a.append(e);
    };
  ...
  function oe(e) {
    ...
    var n = function n(e) {
      if ("string" == typeof e) {
        ...
        _t30.innerHTML = e, i.prepend(_t30.children[0]), _t30.innerHTML = "";
      } else i.prepend(e);
    };
  ...
  var ge = [function (e) {
    ...
    function I(e) {
      ...
      i >= 0 && (g[i] = e), g.length < 2 || (h = !0, v.scaleMove = T(), v.imageEl && (a.scale = v.scaleMove / v.scaleStart * l, a.scale > v.maxRatio && (a.scale = v.maxRatio - 1 + Math.pow(a.scale - v.maxRatio + 1, 0.5)), a.scale < s.minRatio && (a.scale = s.minRatio + 1 - Math.pow(s.minRatio - a.scale + 1, 0.5)), v.imageEl.style.transform = "translate3d(0,0,0) scale(".concat(a.scale, ")")));
    }
    ...
    function $(e) {
      ...
      var n = (a.scale - l) / (v.maxRatio - t.params.zoom.minRatio),
          c = v.originX,
          p = v.originY;
      b.currentX = b.touchesCurrent.x - b.touchesStart.x + b.startX + n * (b.width - 2 * c), b.currentY = b.touchesCurrent.y - b.touchesStart.y + b.startY + n * (b.height - 2 * p), b.currentX < b.minX && (b.currentX = b.minX + 1 - Math.pow(b.minX - b.currentX + 1, 0.8)), b.currentX > b.maxX && (b.currentX = b.maxX - 1 + Math.pow(b.currentX - b.maxX + 1, 0.8)), b.currentY < b.minY && (b.currentY = b.minY + 1 - Math.pow(b.minY - b.currentY + 1, 0.8)), b.currentY > b.maxY && (b.currentY = b.maxY - 1 + Math.pow(b.currentY - b.maxY + 1, 0.8)), y.prevPositionX || (y.prevPositionX = b.touchesCurrent.x), y.prevPositionY || (y.prevPositionY = b.touchesCurrent.y), y.prevTime || (y.prevTime = Date.now()), y.x = (b.touchesCurrent.x - y.prevPositionX) / (Date.now() - y.prevTime) / 2, y.y = (b.touchesCurrent.y - y.prevPositionY) / (Date.now() - y.prevTime) / 2, Math.abs(b.touchesCurrent.x - y.prevPositionX) < 2 && (y.x = 0), Math.abs(b.touchesCurrent.y - y.prevPositionY) < 2 && (y.y = 0), y.prevPositionX = b.touchesCurrent.x, y.prevPositionY = b.touchesCurrent.y, y.prevTime = Date.now(), v.imageWrapEl.style.transform = "translate3d(".concat(b.currentX, "px, ").concat(b.currentY, "px,0)");
    }
    ...
    function Y() {
      ...
      var _H = H(),
          s = _H.passiveListener,
          a = _H.activeListenerWithCapture;
    ...
    function B() {
      ...
      var _H2 = H(),
          s = _H2.passiveListener,
          a = _H2.activeListenerWithCapture;
    ...
    s({
      ...
      setTranslate: function setTranslate() {
        ...
        for (var _e73 = 0, _t51 = a.length; _e73 < _t51; _e73 += 1) {
          ...
          Math.abs(_w2) < 0.001 && (_w2 = 0), Math.abs(_v2) < 0.001 && (_v2 = 0), Math.abs(_f3) < 0.001 && (_f3 = 0), Math.abs(_m4) < 0.001 && (_m4 = 0), Math.abs(_h5) < 0.001 && (_h5 = 0), Math.abs(_b) < 0.001 && (_b = 0);
          ...
          if (me(0, _t52).style.transform = _y, _t52.style.zIndex = 1 - Math.abs(Math.round(_u5)), r.slideShadows) {
            ...
            _e74 || (_e74 = fe("coverflow", _t52, n ? "left" : "top")), _s42 || (_s42 = fe("coverflow", _t52, n ? "right" : "bottom")), _e74 && (_e74.style.opacity = _u5 > 0 ? _u5 : 0), _s42 && (_s42.style.opacity = -_u5 > 0 ? -_u5 : 0);
          }
        }
      },
      setTransition: function setTransition(e) {
    ...
    s({
      ...
      setTranslate: function setTranslate() {
        ...
        for (var _o9 = 0; _o9 < e.length; _o9 += 1) {
          ...
          if (_y2 || _E) {
            var _e77 = Math.pow(1 - Math.abs((Math.abs(_p6) - 0.5) / 0.5), 0.5);

            _v3 += -28 * _p6 * _e77, _g3 += -0.5 * _e77, _w3 += 96 * _e77, _h6 = -25 * _e77 * Math.abs(_p6) + "%";
          }
          ...
          if (i.slideShadows) {
            ...
            _e79 || (_e79 = fe("cards", _d6)), _e79 && (_e79.style.opacity = Math.min(Math.max((Math.abs(_p6) - 0.5) / 0.5, 0), 1));
          }
