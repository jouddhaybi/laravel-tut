...
<div class="car-item card">
    <a href="{{ route('car.show', $car->id) }}">
        <img src="{{ asset('img/' . $car->primaryImage?->image_path) }}" alt="" class="car-item-img rounded-t" />
    </a>
    <div class="p-medium">
        <div class="flex items-center justify-between">
            ...
            <button id="btnHeart" class="btn-heart text-primary" data-carid="{{ $car->id }}">
                ...
                <svg id="filledHeart{{ $car->id }}" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                    fill="currentColor" style="width: 16px" @class([
                        'hidden' => !$car->in_wishlist,
                    ])>
                    <path
